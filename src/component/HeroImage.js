...
import styles  from './Hero.module.css'
 ...
 const HeroImage =()=>{
     return(
      <div className="relative h-96	 md:h-2/5 bg-auto bg-center bg-contain overflow:hidden">
      <img
        src="./traditionalfood.jpg"
        alt="Example"loading="lazy"
        className="w-full h-full opacity-75"
      />
      <div className="absolute  md:top-[40px] left-0 right-0 top-[10px] flex items-center md:justify-center brightness-125">
        <div className="flex flex-col gap-2 md:gap-5 md:block hidden">
            <div>
